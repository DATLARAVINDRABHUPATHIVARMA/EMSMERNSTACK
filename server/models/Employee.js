...
const employeeSchema = new Schema({
  ...
  preHNo: { type: String, required: true},
  preStreet: { type: String, required: true},
  preVillage: { type: String, required: true},
  preMandal: { type: String, required: true},
  preCity: { type: String, required: true},
  preState: { type: String, required: true},
  preCountry: { type: String, required: true},
  prePincode: { type: String, required: true},
  perHNo: { type: String, required: true},
  perStreet: { type: String, required: true},
  perVillage: { type: String, required: true},
  perMandal: { type: String, required: true},
  perCity: { type: String, required: true},
  perState: { type: String, required: true},
  perCountry: { type: String, required: true},
  ...
  empStatus: { type: String, enum: ["Active", "Resigned"], required: true },
