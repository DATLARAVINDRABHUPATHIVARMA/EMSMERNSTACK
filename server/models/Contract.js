...
const contractSchema = new mongoose.Schema({
    ...
    indNOTs: { type: String, enum: ["GEN", "G-S", "G-4", "Per Hour", "Per Day", "Per Hour / Per Day", "P.M / 8", "G-S / 8", "26 Days / 8 Hours", "22", "23", "24", "25", "26", "27", "30", "31"], enum: [ "noUniform", "noAdvSal", "noLWF", "noRegFee",], /*noUniform: { type: Boolean, default: false, }, noAdvSal: { type: Boolean, default: false, },  noLWF: { type: Boolean, default: false, }, noRegFee: { type: Boolean, default: false, },*/ },
