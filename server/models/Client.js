...
const clientSchema = new Schema({
    ...
    clientShipCountry: { type: String, enum: [ "India", "Other" ] },
    clientShipPincode: { type: String, },
    shipGSTNo: { type: String, validate: { validator: function (v) { return /^\d{2}[A-Z0-9]{13}$/.test(v);  }, message: props => `${props.value} is not a valid GST number!` } },
    shipCountry: { type: String, },
    shipPANNo: { type: String, },
    orderNo: { type: String, },
