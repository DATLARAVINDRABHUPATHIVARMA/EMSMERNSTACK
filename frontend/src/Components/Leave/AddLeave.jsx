      ...
      <form onSubmit={handleSubmit}>
        <div className='flex flex-col space-y-4'>
          ...
          <div>
            ...
            <textarea name='reason' placeholder='Reason' onChange={handleChange} className='mt-1 p-2 block w-full border border-gray-300 rounded-md' rows={3} required></textarea>
          </div>
        </div>
