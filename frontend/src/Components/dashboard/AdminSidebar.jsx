  ...
  return (
    <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 space-y-2 w-64'>
      ...
      <div className='px-4'>
        ...
        <NavLink to='/admin-dashboard/employees' className={({isActive}) => `${isActive ? "bg-purple-500" : " "} flex items-center space-x-4 block py-2.5 px-4 rounded`}>
          <FaUsers /> 
          <span>Employee</span> 
        </NavLink>
        ...
        <NavLink to='/admin-dashboard/salary' className={({isActive}) => `${isActive ? "bg-purple-500" : " "} flex items-center space-x-4 block py-2.5 px-4 rounded`}>
          <FaMoneyBillWave /> 
          <span>Salary</span> 
        </NavLink>
